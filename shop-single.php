                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <ul class="list-inline">
                                ...
                                <li class="list-inline-item">
                                    <p class="text-muted"><strong><?php echo $row['product_brand'];?></strong></p>
                                </li>
                            </ul>
                            ...
                            <ul class="list-inline">
                                ...
                                <li class="list-inline-item">
                                    <p class="text-muted"><strong><?php echo $row['product_color'];?></strong></p>
                                </li>
                            </ul>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-auto">
                                        <ul class="list-inline pb-3">
                                            ...
                                            <!-- <li class="list-inline-item"><span class="btn btn-success" id="Lower Value" onclick="lowerValue()">-</span></li>
                                            <li class="list-inline-item"><span class="badge bg-secondary" id="var-value">1</span></li>
                                            <li class="list-inline-item"><input type="text" id="number" value="0"/></li>
                                             <input type="text" id="number" value="0"/> 
                                            <li class="list-inline-item"><input type="button" class="btn btn-success" id="Increment Value" onclick="incrementValue()">+</input></li> -->
                                        </ul>
                                    </div>
                                </div>
                                <div class="row pb-3">
